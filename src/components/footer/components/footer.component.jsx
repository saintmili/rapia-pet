      ...
      <div className="footer">
        ...
        <div className="footer-container">
          <div className="footer-benefits">
            {footerBenefits.map((benefit) => (
              <div className="footer-benefit" key={benefit.id}>
                ...
                <div className="footer-benefit-title">{benefit.title}</div>
              </div>
            ))}
          </div>
          <div className="footer-aboutus">
            <h2 className="footer-aboutus-title">درباره رآبیاپت</h2>
            <p className="footer-aboutus-description">
              رآبیاپت در سال 1400 با هدف فرهنگ سازی در زمینه‌ی نگهداری از سگ و
              بهبود کیفیت خدمات بهداشتی، درمانی و آموزشی در ایران متولد شد.
            </p>
            <div className="footer-aboutus-links">
              ...
              <div className="footer-aboutus-links-address">
                ...
                <h4>
                  شیراز – پل معالی اباد – ساختمان الف –طبقه ۳ واحد ۳۰۲ (مراجعه
                  با هماهنگی)
                </h4>
              </div>
            </div>
          ...
          <div className="footer-certificates">
            <h2 className="footer-certificates-title">مجوزها</h2>
            <div className="fotter-certificates-container"></div>
          </div>
        </div>
        <div className="footer-copyrights">
          <h6>تمام حقوق سایت برای پت شاپ محفوظ می‌باشد ©</h6>
          <h6>
            طراحی و توسعه توسط:
            <img src={SitechLogo} alt="" />
          </h6>
        </div>
      </div>
    );
